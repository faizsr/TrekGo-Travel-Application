...
import 'package:trekgo_project/src/feature/destination/presentation/widgets/drawer_item.dart';
              ...
              StreamBuilder<UserEntity>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      String username = user.name.capitalise();
                      String useremail = user.email;
                      String userProfile = user.profilePhoto;
                      return InkWell(
                        onTap: () {
